 ...
 */
public class PathingCell extends Cell {

    private Tile tile;
    private int type;

    public PathingCell(int x, int y) {
        this(x, y, Tiles.PATHING_WALKABLE);
    }

    public PathingCell(int x, int y, int type) {
        super(x, y);

        this.type = type;
        this.tile = Tiles.getTile(type);
    }
    ...
    public boolean walkable() {
        return type == Tiles.PATHING_WALKABLE || type == Tiles.PATHING_INTERACTABLE;
    }
